...
export function WatchPlayerBand({ children }: { children: ReactNode }) {
  return (
    <div className="box-border flex w-full items-center justify-center border-b border-border px-3 py-3 sm:px-6 sm:py-5 lg:px-10">
...
export function WatchSeriesTheater({
  ...
  return (
    <div className="box-border w-full border-b border-border px-3 py-3 sm:px-6 sm:py-5 md:px-8">
      <div className="watch-series-theater flex w-full flex-col overflow-hidden rounded-lg border border-border">
        <div className="relative min-h-0 min-w-0 w-full bg-black lg:flex-1">
          <div className="watch-player-frame watch-player-frame--theater">
            {media}
          </div>
        </div>
