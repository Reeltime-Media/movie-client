...
export function PageSearchBar({
  ...
  return (
    <div
      className="group relative flex w-full max-w-2xl items-center rounded-md border border-border bg-surface transition-colors focus-within:border-border-hover focus-within:bg-surface-elevated"
      role="search"
    >
      ...
      <input
        ...
        spellCheck={false}
        className={[
          "min-h-11 w-full rounded-md bg-transparent py-2 pl-10 text-[13px] leading-normal text-text outline-none placeholder:text-text-disabled",
