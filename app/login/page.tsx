...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-bg text-text">
      ...
      >
        {/* Background photo — movie theater seats */}
        <div
        ...
        <div className="relative z-10">
          <p className="text-[24px] font-extrabold leading-tight tracking-[-0.025em] text-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-[380px]">
          ...
          <form className="space-y-4" action="#" method="post">
            ...
            <button
              type="submit"
              className="mt-1 w-full rounded-md bg-brand py-2.5 text-[13px] font-bold text-white transition-colors hover:bg-brand-hover"
            >
              Sign in
            </button>
          </form>
